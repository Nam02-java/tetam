...
public class API_3 {
    ...
    private String URL_WEBSITE = "https://outerity.com/products/outerity-double-tee-collection-blue-heart-dark-slate";

    @GetMapping("/DarkSlate_sigin")
    ...
    public ResponseEntity<?> DJBear_NoSigin(@RequestParam Map<String, String> params) throws InterruptedException, IOException, TelegramApiException {
        ...
        return ResponseEntity.ok(new String("Successful payment withouthttps://github.com/Nam02-java/Puterity.git login"));
    }
}
