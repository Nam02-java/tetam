...
public class API_4 {
    ...
    private String URL_WEBSITE = "https://outerity.com/products/outerity-double-tee-collection-fried-egg-gray-pinstripe";

    @GetMapping("/FriedEgg_sigin")
