...
public class API_1 {
    ...
    private String URL_WEBSITE = "https://outerity.com/products/outerity-double-tee-collection-dj-bear-canoli-cream";


    @GetMapping("/DJBear_sigin")
    public ResponseEntity<?> DJBear_sigin(@RequestParam Map<String, String> params) throws InterruptedException, IOException, TelegramApiException {
        ...
        options.setHeadless(true); // tắt UI
        ...
        js.executeScript("arguments[0].click();", driver.findElement(By.xpath("(//span[contains(text(),'Đăng nhập / Đăng ký')])[1]")));
        Thread.sleep(1000);
