...
public class API_2 {
    ...
    private String URL_WEBSITE = "https://outerity.com/products/outerity-double-tee-collection-corgi-white-pepper";


    @GetMapping("/Corgi_sigin")
